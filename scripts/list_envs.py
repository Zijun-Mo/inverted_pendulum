...
All the environments are registered in the `inverted_pendulum` extension. They start
...
import inverted_pendulum.tasks  # noqa: F401


def main():
    """Print all environments registered in `inverted_pendulum` extension."""
